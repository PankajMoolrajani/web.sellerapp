				...
				<div id="div-file" class="col-md-8 navbar-form navbar-left navbar-collapse collapse">
					<div class="row">
						<div class="col-sm-12 col-md-12">						 							 
							<form action="UploadOrderFile" id="form-bulk-order-upload" class="navbar-form navbar-left" method="post" enctype="multipart/form-data">
							  <div class="form-group">    								
							  	<input type="file" size="60" id="input-file-bulk-order-upload" name="order-upload-file">
							  </div>							  
							  <button type="submit" class="btn btn-default">Upload File</button>
							  <span id="span-bulk-order-file-status"></span>
							</form>					        			 								   
						</div>
					</div>											    				    					    				    							    				    			    			
				</div>
