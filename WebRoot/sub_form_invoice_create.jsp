...
<div id="row">	
	<div id="div-form-invoice-create-tab-pages" class="tab-content col-md-12 col-sm-12">
		<div class="tab-pane active" id="div-form-invoice-create-invoice-lines">
			<jsp:include page="form_invoice_create_lines.jsp"></jsp:include>		           
		</div>
		<div class="tab-pane" id="div-form-invoice-create-procurement-invoice-info">
			<jsp:include page="form_invoice_create_info.jsp"></jsp:include>
		</div>
		<div class="tab-pane" id="div-form-invoice-create-invoice-payment">
