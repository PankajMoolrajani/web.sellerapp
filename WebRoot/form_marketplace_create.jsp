		  ...
		  <div class="modal-dialog modal-sm">
		    <div class="modal-content">
		      ...
		      <div id="div-form-pMarketplace-submit" class="modal-footer">
		        <button type="button" id="btn-form-invMarketplace-close" class="btn btn-default" data-dismiss="modal">Close</button>
		        <button type="button" id="btn-form-invMarketplace-submit" class="btn btn-primary">Create</button>
		      </div>
		    </div>
		  </div>
		</div>